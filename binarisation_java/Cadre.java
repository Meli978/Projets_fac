...
public class Cadre extends JFrame implements ActionListener {
	...
	private final JMenuItem enregistrerMenu = new JMenuItem();
        private final JMenuItem seuillageFixeMenu = new JMenuItem();
        private final JMenuItem histogrammeMenu = new JMenuItem();
        private final JMenuItem lyoldMenu = new JMenuItem();
	...
	private void creerMenu() throws Exception {
		...
		filtreMenu.setText("Filtre");
                ...
                filtreMenu.add(lyoldMenu);
		lyoldMenu.addActionListener((ActionListener)this);
		lyoldMenu.setText("Methode Lyold");
                
                filtreMenu.add(histogrammeMenu);
		histogrammeMenu.addActionListener((ActionListener)this);
		histogrammeMenu.setText("Seuillage Fixe");
...
//                        } else
//			if (cliqueMenu.getSource().equals(lyoldMenu)) {
//				panneau.lyold();
			}else if (cliqueMenu.getSource().equals(histogrammeMenu)) {
				panneau.histogramme();
