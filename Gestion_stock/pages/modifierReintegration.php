...
include 'fonctions/bsm.func.php';
  foreach(recuperer_produit_reintegration() as $reintegration){
...
<div  class = "bouton_search">
  <div id="buttons">
   <button class="btn blue" onclick="ajouter()"><a href="#" id ="ajouter">Ajouter d'autres BSM</a></button>
 </div>
</div>
 ...
 <form class="" action="" method="post">
  ...
  <header id="header">
    ...
    <span id="date">Date: <input type="text" name="date" value=""></span>

      <button  onclick="window.print()" name="imprimer" class="forwarder-icon" id="imprimer" >
          <svg><use xlink:href="#ion-printer" id="printer"></use></svg>
      </button>

      <button  name="modifier" class="forwarder-icon">
  ...
  <section>
    <p>
      <span>Numero de bon: <strong><?php echo $reintegration->id ?></strong></span>
    </p>
  ...
  <tbody id="tbody">
    <?php
     ...
     ?>
    <tr>
      <td> <input type="text" name="" value="<?php echo $nom[$i]; ?>"></td>
      <td> <input type="text" name="" value="<?php echo $qte[$i]; ?>"></td>
      <?php
        $produit = recuperer_donnes_produit($nom[$i]);
...
<div class="item" id="item">
   <span>Total : <?php echo $total_produit; ?></span>
</div>
...
if(isset( $_POST['modifier'])){
  ...
  <script type="text/javascript">
    window.open("index.php?page=supModifReintegration","_self");
  </script>
