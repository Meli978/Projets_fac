...
<div class="" id="divImprimer" >
  ...
  <header id="header">
    ...
    <span id="date">Date:  <?php echo $bmm->date ?> </span>

      <a href="index.php?page=supModifBmm&id=<?php echo $id; ?>">
  ...
  <section>
    <p>
      <span>Numero de bon: <strong> <strong><?php echo $bmm->id ?></strong></span>
    </p>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Quantite mis en magasin</th>
