  ...
  if(isset($_POST["supp_modif"])){
      ...
      supprimer_reintegration($id);
        ?>
         ...
         <script type="text/javascript">
          window.open("index.php?page=reintegrationDefinitif", "_self");
        </script>
        <?php
    }
    else{
    ...
    //////fin lecture lignes///////////////////
      if(($insertion_impossible == 0) && ($ligne_vide!==$nb) && (!empty($tab_nom)) &&(!empty($tab_qte))){
        ...
        modifier_reintegration($id,$tab_nom_reintegration, $tab_qte_reintegration,$date);
?>
      <script type="text/javascript">
      window.open("index.php?page=reintegrationDefinitif", "_self");
      </script>
