...
$id = $_GET['id'];
  ...
  foreach(recuperer_dai_entier() as $dai){
    if(($dai->id) == $id){
    $id      = $dai->id;
...
<div class="" id="divImprimer" >
  ...
  <header id="header">
    ...
    <span id="date">Date:  <?php echo $dai->date ?> </span>


      <button  id="imprimer" name="imprimer" class="forwarder-icon"  >
          <svg><use xlink:href="#ion-printer" id="printer"></use></svg>
      </button>

      <a href="index.php?page=supModifdai&id=<?php echo $id; ?>">
...
<script type="text/javascript" src="js/dai.func.js"></script>
