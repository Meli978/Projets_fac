...
foreach(recuperer_reintegration_entier() as $reintegration){
  $id_reintegration      = $reintegration->id;
  if($id == $id_reintegration){
...
<div class="" id="divImprimer" >
  ...
  <header id="header">
    ...
    <span id="date">Date:  <?php echo $reintegration->date ?> </span>

      <a href="index.php?page=supModifReintegration&id=<?php echo $id; ?>">
  ...
  <section>
    <p>
      <span>Numero de bon: <strong> <strong><?php echo $reintegration->id ?></strong></span>
    </p>
