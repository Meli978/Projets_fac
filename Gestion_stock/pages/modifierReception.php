...
include 'fonctions/bsm.func.php';
  foreach(recuperer_produit_reception() as $reception){
...
<div  class = "bouton_search">
 ...
 <form class="" action="" method="post">
  ...
  <header id="header_<?php echo $key; ?>">
    ...
    <span id="date">Date: <input type="text" name="date" value="">"/> </span>
      <button  name="modifier_<?php echo $key; ?>" class="forwarder-icon">
...
if(isset( $_POST['modifier'])){
  ...
  <script type="text/javascript">
    window.open("index.php?page=supModifReception","_self");
  </script>
